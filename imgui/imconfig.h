...
// - plutosvg will support more fonts and may load them faster. It currently requires to be built manually but it is
// fairly easy. See misc/freetype/README for instructions.
